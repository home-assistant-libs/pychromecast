...
class CastMessage(_message.Message):
    ...
    def __init__(
        self,
        protocol_version: _Optional[_Union[CastMessage.ProtocolVersion, str]] = ...,
        source_id: _Optional[str] = ...,
        destination_id: _Optional[str] = ...,
        namespace: _Optional[str] = ...,
        payload_type: _Optional[_Union[CastMessage.PayloadType, str]] = ...,
        payload_utf8: _Optional[str] = ...,
        payload_binary: _Optional[bytes] = ...,
    ) -> None: ...
...
class AuthChallenge(_message.Message):
    ...
    def __init__(
        self,
        signature_algorithm: _Optional[_Union[SignatureAlgorithm, str]] = ...,
        sender_nonce: _Optional[bytes] = ...,
        hash_algorithm: _Optional[_Union[HashAlgorithm, str]] = ...,
    ) -> None: ...
...
class AuthResponse(_message.Message):
    ...
    def __init__(
        ...
        client_auth_certificate: _Optional[bytes] = ...,
        intermediate_certificate: _Optional[_Iterable[bytes]] = ...,
        signature_algorithm: _Optional[_Union[SignatureAlgorithm, str]] = ...,
        sender_nonce: _Optional[bytes] = ...,
        hash_algorithm: _Optional[_Union[HashAlgorithm, str]] = ...,
        crl: _Optional[bytes] = ...,
...
class DeviceAuthMessage(_message.Message):
    ...
    def __init__(
        self,
        challenge: _Optional[_Union[AuthChallenge, _Mapping]] = ...,
        response: _Optional[_Union[AuthResponse, _Mapping]] = ...,
        error: _Optional[_Union[AuthError, _Mapping]] = ...,
    ) -> None: ...
